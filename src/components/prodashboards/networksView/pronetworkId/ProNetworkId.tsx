...
import { ProNetworkEdit } from './edit/ProNetworkEdit'
import { ProAccessKeys } from './accesskeys/ProAccessKeys'
import { useNetwork } from '~util/network'
import { NotFound } from '~util/errorpage'
import { ProNetworkListEdit } from './edit/ProNetworkListEdit'

export const ProNetworkId: React.FC = () => {
    ...
    <>
      <Switch>
        ...
        <Route path={`${path}/edit/networkusers`}>
          <ProNetworkListEdit netid={netid} field="users" />
        </Route>
        <Route path={`${path}/edit/groups`}>
          <ProNetworkListEdit netid={netid} field="groups" />
        </Route>
          ...
          >
            ...
            <Grid item xs={12} sm={4} md={3.1}>
              <TextField
                disabled
                value={
                  hasProSettings ? network.prosettings?.defaultaccesslevel : 2
                }
            ...
            <Grid item xs={12} sm={4} md={3.1}>
              <TextField
                disabled
                value={
                  hasProSettings ? network.prosettings?.defaultusernodelimit : 0
                }
            ...
            <Grid item xs={12} sm={4} md={3.1}>
              <TextField
                ...
                value={
                  hasProSettings
                    ? network.prosettings?.defaultuserclientlimit
                    : 0
                }
            ...
            <Grid item xs={12} sm={5} md={5} style={centerStyle}>
              <TextField
                ...
                value={
                  hasProSettings
                    ? network.prosettings?.allowedgroups.join(',')
                    : ''
                }
            ...
            <Grid item xs={12} sm={5} md={5} style={centerStyle}>
              <TextField
                ...
                value={
                  hasProSettings
                    ? network.prosettings?.allowedusers.join(',')
                    : ''
                }
